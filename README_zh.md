...
执行完成后，当前目录下应生成`demo-eye-remote-control`文件夹。
...
在`demo-eye-remote-control`路径下执行`./start.sh`启动脚本。
...
## 报告问题
如在使用过程中遇到问题，欢迎在[移远官方论坛](https://forumschinese.quectel.com/t/topic/12199) 提交技术咨询，我们的技术支持团队将及时为您解答。
